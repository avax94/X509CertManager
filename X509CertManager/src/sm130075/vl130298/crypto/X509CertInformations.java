 ...
 * @see X509CertImpl
 */
public class X509CertInformations implements CertAttrSet<String> {
    /**
     ...
     */
    public X509CertInformations(byte[] cert) throws CertificateParsingException {
        try {
     ...
     * @exception CertificateParsingException on parsing errors.
     */
    public X509CertInformations(DerValue derVal) throws CertificateParsingException {
        try {
            parse(derVal);
        } catch (IOException e) {
            CertificateParsingException parseException =
    ...
    public boolean equals(Object other) {
        if (other instanceof X509CertInformations) {
            return equals((X509CertInformations) other);
        } else {
            return false;
        }
    }
     ...
     * @return true iff the certificates are equivalent
     */
    public boolean equals(X509CertInformations other) {
        if (this == other) {
            return(true);
